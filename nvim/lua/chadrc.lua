...
M.base46 = {
  ...
  hl_override = {
    ...
    WhiteSpace                       = { fg = colors.gruberdarkerbg1d },
    NonText                          = { fg = colors.gruberdarkerbg1d },
    ...
    Cursor                           = { fg = colors.gruberdarkerfg },
    ...
    Number                           = { fg = colors.gruberdarkerniagara },
    Float                            = { fg = colors.gruberdarkerniagara },
    Character                        = { fg = colors.gruberdarkerniagara },
    ...
    Include                          = { fg = colors.gruberdarkeryellow },
    ...
    NvimTreeNormal                   = { fg = colors.gruberdarkerfg, bg = colors.gruberdarkerbg },
    NvimTreeNormalNC                 = { fg = colors.gruberdarkerfg, bg = colors.gruberdarkerbg },
    ...
    Directory                        = { fg = colors.gruberdarkerquartz },
    ...
    ["@number"]                      = { fg = colors.gruberdarkerniagara },
    ["@number.float"]                = { fg = colors.gruberdarkerniagara },
    ["@character"]                   = { fg = colors.gruberdarkerniagara },
